...
SolarSystem::SolarSystem()
{
	...
	stars[Sun] = new LightPlanet(SUM_RADIUS, 0, 0, SELFROTATE, 0, rgbColor);
	...
	stars[Moon] = new Planet(MOO_RADIUS, MOO_DIS, MOD_SPEED, SELFROTATE, stars[Earth], rgbColor);
